<x-app-layout>
    <section class="banner">
        <div class="text-center bg-[url('assets/image/banner/women.jpg')] bg-cover h-[250px] items-center justify-center flex relative">
            <h1 class="text-3xl font-light tracking-wide text-white ">WOMENS COLLECTION</h1>
